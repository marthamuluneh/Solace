...
export default function Home() {
  ...
  const text = {
    ...
    am: {
      ...
      sub: "ፍቃድ ካላቸው ኢትዮጵያዊ ሳይኮሎጂስቶች ጋር ይገናኙ — ለግንኙነት፣ ለቤተሰብ፣ ለጭንቀት፣ ለሀዘን፣ እና ለሌሎች ችግሮች።",
      btn1: "ይጀምሩ — ነፃ ነው",
      btn2: "ተጨማሪ ይወቁ",
      ...
      step2desc: "የግል ምክር፣ የቡድን ሕክምና፣ የእኩያ ቻት — እርስዎ ይወስኑ።",
      step3title: "በሚስጥር ይገናኙ",
      step3desc: "ፍቃድ ካላቸው ኢትዮጵያዊ ሳይኮሎጂስቶች ጋር በቪዲዮ ወይም በአካል።",
      whyTitle: "ለምን ሶላስ?",
      w1title: "40-50% ርካሽ",
      w1desc: "ከግል ክሊኒኮች ባነሰ ዋጋ።",
      ...
      w5title: "ድምፅዎ ተደብቋል",
      w5desc: "የቡድን ሕክምና ክፍለ ጊዜዎች ላይ የድምፅ መደበቂያ ይጠቀማሉ።",
      w6title: "የዕለት የአዕምሮ ጤና መከታተያ",
      w6desc: "በየዕለቱ ይመዝግቡ እና የጤንነትዎን ሁኔታዎነ ይከታተሉ።",
      s1title: "የግል ምክር",
      s1desc: "ከተረጋገጡ ኢትዮጵያዊ ሳይኮሎጂስቶች ጋር የግል ክፍለ ጊዜ።",
      s2title: "የቡድን ሕክምና",
      s2desc: "ከ6-10 ሰዎች ጋር ፍቃድ ባላቸው ሳይኮሎጂስቶቸ። ድምፅ ተደብቋል።",
      s3title: "የእኩያ ድጋፍ ቻት",
